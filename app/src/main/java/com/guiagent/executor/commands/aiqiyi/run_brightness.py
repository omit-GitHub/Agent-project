...
def run_up(params=None):
    ...
    return success("aiqiyi.brightness_up", f"brightness_up x{count}")


def run_down(params=None):
    """aiqiyi.brightness_down — 调暗亮度。
    ...
    return success("aiqiyi.brightness_down", f"brightness_down x{count}")
